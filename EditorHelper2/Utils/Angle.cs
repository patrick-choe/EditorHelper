...
namespace EditorHelper.Utils {
    public static class Angle {
        private static readonly List<char> Specials = new List<char> {'!', '5', '6', '7', '8', '9'};
        private static readonly Dictionary<int, char> AngleChar = new() {
            {0, 'R'},
            {15, 'p'},
            {30, 'J'},
            {45, 'E'},
        ...
        public static char RotateFloor(char chara, float rotation) {
            ...
            float angle = scrLevelMaker.GetAngleFromFloorCharDirectionWithCheck(chara, out _);
            int rot = Mathf.RoundToInt(angle + rotation).NormalizeAngle();
        ...
        public static float GetAngleDiff(this scrFloor floor, bool checkCW = true) {
            ...
            if (floor.nextfloor == null) return 180;
